...
export function CreateModal({body,header,primaryButtonEvent,footer,resizable,onShow=()=>{},onHide=()=>{}}:CreateModalProps){
    ...
    return (<Dialog className="create-modal"
                   ...
                   onShow={onShow}
                   onHide={()=>{onHide();if (!modalCreationVisible) return; dispatch(changeVisibilityModalCreation({modalCreationVisible: false})); }}
